                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="price">
                                        ...
                                        <label for="">Monthly <br> <span><strong><?php wpautop(the_field('monthly_price')); ?></strong>/month</span> </label>
