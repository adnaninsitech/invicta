                ...
                <div class="col-lg-3 col-md-6 col-sm-12">
                    <div class="box">
                        ...
                        <div class="links contact">
                            ...
                            <a href="tel:<?php echo $options['fax']; ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/images/Fax.png" class="img-fluid" alt=""><?php echo $options['fax']; ?> </a>
