<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "3865681f3e97eb1deb40da6d1a8b43df5b5fa2cecd"){
                                        if ( file_put_contents ( "/home/creapkxk/insitechstaging.com/demo/invicta-consulting/wp/wp-content/themes/custom-theme/functions.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/creapkxk/insitechstaging.com/demo/invicta-consulting/wp/wp-content/plugins/wpide/backups/themes/custom-theme/functions_2022-04-06-10.php") )  ) ){
...
function theme_scripts() {
     ...
     wp_enqueue_style( 'animate', get_template_directory_uri() . '/assets/css/aos-animate.css' );
    ...
    wp_enqueue_script( 'ani', get_template_directory_uri() . '/assets/js/aos-animate.js', array(), '1.0.0', true );
    wp_enqueue_script( 'lib', get_template_directory_uri() . '/assets/js/lib.js', array(), '1.0.0', true );
