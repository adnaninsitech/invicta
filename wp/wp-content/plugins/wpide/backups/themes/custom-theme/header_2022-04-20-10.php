...
.ml2 .letter , .ml3 .letter, .ml5 .letter {
  display: inline-block;
  line-height: 1em;
}

.home-sec-3 .heading h2 span { font-size : 82px; color : #000;   font-family: "Domaine Semibold"; }
</style>
