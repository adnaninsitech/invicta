                        ...
                        <div class="boost-table tab-pane active" id="home" role="tabpanel">
                            <table>
                                <tbody>
                                    ...
                                    <?php $index_query = new WP_Query(array( 'post_type' => 'boost' , 'order' => 'asc')); ?>
                                           <?php while ($index_query->have_posts()) : $index_query->the_post(); ?>
                                           
                                    <?php $color = get_field('full_business_credit_reports'); ?>
                                    
                                    <tr>
                                        <td>Full business credit reports & scores: Dun & Bradstreet® • Experian® • Equifax®</td>
                                        
                                        <?php if (get_field('full_business_credit_reports') == 'yes') { ?>
                                        
                                        <td><strong>Summary Only</strong></td>
                                        
                                        <?php } else{ echo get_field('full_business_credit_reports'); ?>
                                        
                                        <td><img src="https://insitechstaging.com/demo/invicta-consulting/wp/wp-content/uploads/2022/04/check-1.jpg" alt=""></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <!-- <img src="assets/images/business-boost/check.jpg" alt=""> -->
                                        </td>
                                        <td>
                                            <!-- <img src="assets/images/business-boost/check.jpg" alt=""> -->
                                        </td>
