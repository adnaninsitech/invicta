                            ...
                            <table>
                                <tbody>
                                    ...
                                    <tr >
                                        ...
                                        <td class="select"><a href="<?php echo the_permalink(); ?>">Select</a></td>
                                        <td class="select"><a href="<?php echo the_permalink(); ?>">Select</a></td>
                                        <td class="select"><a href="<?php echo the_permalink(); ?>">Select</a></td>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <?php $count=0; $index_query = new WP_Query(array( 'post_type' => 'boost' , 'order' => 'asc')); ?>
                                         ...
                                         <td width="25%"> 
                                            <strong><?php echo the_title(); ?></strong>
                                            <span class="amount">$ <?php echo the_field('quaterly_price'); ?>/month</span> 
