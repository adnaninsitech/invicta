 ...
 <?php $count=0; $index_query = new WP_Query(array( 'post_type' => 'boost')); ?>
                ...
                <div class="col-md-12">
                    <div class="tab-content">
                        ...
                        <div class="boost-table tab-pane <?php if($count==0) {echo 'active' ;} ?>" id="home" role="tabpanel">
                            <table>
                                <tbody>
